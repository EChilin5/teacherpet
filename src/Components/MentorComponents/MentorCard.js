    ...
    <div className="mentor-card">
      ...
      <div className="mentor-card-right">
        <div classname="mentor-card-description">
          <div className="mentor-card-name">{props.mentors.name}</div>
          <div className="mentor-card-email">Email: {props.mentors.email}</div>
          <div className="mentor-card-subject">
            Specialty: {props.mentors.subject}{" "}
          </div>
        </div>
      </div>
    </div>
